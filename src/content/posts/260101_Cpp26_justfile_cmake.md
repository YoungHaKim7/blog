---
title: 260101_Cpp26_justfile_cmake
published: 2026-01-01
description: 'C++26 + Cmakefile + clang-format + justfile'
image: ''
tags: [cpp, justfile, cmake, clang-format]
category: 'z_cpp'
draft: false 
lang: ''
---
...
- 세팅 기준일 251004
- [`justfile` (Cpp26  으로 세팅함)](#c26-justfile)
- [`CMakeLists.txt` (cmake파일 C++26 으로 세팅함)](#c26-cmakeliststxt)
- [`.clang-format` (fmt정렬 세팅 clang-format 21로 세팅함)](#clang-format21기준)

- [여기에 정리중.  러스트 개발자가 알아야할 기초 언어 C/C++/Zig/Haskell](https://github.com/YoungHaKim7/C_Programming_Kernigan_and_Ritchie/tree/main/005_snippets_Cpp_code/a01_hello_cpp_26_ver2)


<hr />

# C++26 CMakeLists.txt[|🔝|](#link)
