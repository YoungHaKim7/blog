---
title: 260214_PostgreSQL_and_Rust_DB_001
...
- 유튜브 영상 이게 젤 좋다.
  - [(190404)Learn PostgreSQL Tutorial - Full Course for Beginners freeCodeCamp.org](https://youtu.be/qw--VYLpxG4)
  - 예시만 훔치자
    - [(250919)Postgres는 데이터베이스가 아닙니다. | DevOps Toolbo ](https://youtu.be/b7eXdUOzUTM?si=nEivIrtZtfPoXQAm)
...
# postgres서버 잘 돌아가는지(status) 확인(LinuxOS)
